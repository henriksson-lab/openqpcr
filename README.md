...
See [`NOTICE`](NOTICE) for the full trademark, interoperability, and non-affiliation
statement, and [`docs/optics-sources.md`](docs/optics-sources.md) for the public
